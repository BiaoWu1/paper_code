...
class AC(nn.Module):
    def __init__(self, gate_channel, reduction_ratio=16, num_layers=1):
        ...
        for i in range( len(gate_channels) - 2 ):
            ...
            #paper not use ReLU()    <BA2M: A Batch Aware Attention Module for Image Classification>
...
class AGS(nn.Module):
    ...
    def forward(self, x):
        ...
        #paper has not use this part      <BA2M: A Batch Aware Attention Module for Image Classification>
        #out = mask + x
        return mask

class BA2M(nn.Module):
    def __init__(self, gate_channels, reduction_ratio=16):
        super(BA2M, self).__init__()
