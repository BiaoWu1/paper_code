...
class ALS(nn.Module):
    def __init__(self, gate_channel, reduction_ratio=16):
        ...
        self.gate_s.add_module( 'gate_s_conv_1', nn.Conv2d(gate_channel, gate_channel//reduction_ratio, kernel_size=1, stride=1, padding=0))
        ...
        self.gate_s.add_module( 'gate_s_conv_1', nn.Conv2d(gate_channel//reduction_ratio, gate_channel, kernel_size=1, stride=1, padding=0))
...
class SA2M(nn.Module):
    ...
    def forward(self, x):
        ...
        max_of_AC_and_ALS = np.maxinum(AC_out, GAP_ALS_out)
        max_of_final = np.maxinum(max_of_AC_and_ALS, GAP_AGS_out)
        #mean
